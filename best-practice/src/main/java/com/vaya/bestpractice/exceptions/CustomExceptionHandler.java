package com.vaya.bestpractice.exceptions;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		if (ex.getCause() != null && ex.getCause() instanceof InvalidFormatException) {
			errors.add("Invalid Type : " + ex.getCause().getMessage());
	    }
    ...
    public ResponseEntity<Object> handleConflict(DataIntegrityViolationException ex) {
        // Nothing to do
		List<String> errors = new ArrayList<String>();
		errors.add("Conflict Error: "+ ex.getCause().getMessage());
		ApiError apiError = new ApiError(HttpStatus.CONFLICT, "Conflict in URL: ", errors);
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
    }
